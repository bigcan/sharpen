...
from finrl_pro_ds.mlops.fingerprint import ExperimentFingerprint
...
class Trainer:
    ...
    def run(
        ...
        *,
        ...
        self._logger.log_event(
            "finrl_pro_ds.training.fingerprint_recorded",
            context={
    ...
    def reproduce(self, fingerprint_id: str) -> ExperimentFingerprint:
        ...
        self._logger.log_event(
            "finrl_pro_ds.training.reproduce",
            context={
                "fingerprint_id": fingerprint.fingerprint_id,
    ...
    def register_model(self, run_id: str, model_name: str) -> None:
        ...
        try:
            ...
            self._logger.log_event(
                "finrl_pro_ds.training.model_registered",
                context={"run_id": run_id, "model_name": model_name},
            )
        except ImportError:
            self._logger.log_event("finrl_pro_ds.training.mlflow_unavailable", level=30)
        except Exception as e:
            self._logger.log_event(
                "finrl_pro_ds.training.model_registration_failed",
                level=40,
    ...
    def _enforce_risk(
        ...
        *,
        ...
        if capital is not None and capital > profile.max_capital_at_risk:
            ...
            self._logger.log_event(
                "finrl_pro_ds.risk.capital_breach",
        ...
        if leverage is not None and leverage > profile.leverage_cap:
            ...
            self._logger.log_event(
                "finrl_pro_ds.risk.leverage_breach",
                level=logging.WARNING,
                context={
                    "leverage": leverage,
        ...
        if (
            ...
            self._logger.log_event(
                "finrl_pro_ds.risk.turnover_breach",
                level=logging.WARNING,
                context={
        ...
        if (
            ...
            self._logger.log_event(
                "finrl_pro_ds.risk.transaction_cost_breach",
                level=logging.WARNING,
                context={
    ...
    def _log_mlflow_run(
        ...
        try:
            ...
            self._logger.log_event(
                "finrl_pro_ds.training.mlflow_unavailable",
                level=30,
