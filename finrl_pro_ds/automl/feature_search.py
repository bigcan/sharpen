...
def run_study(args: argparse.Namespace) -> None:
    ...
    manifest = Path(exp_cfg.get("fingerprint_manifest", "finrl_pro_ds/configs/fingerprints.yaml"))
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="finrl_pro_ds.automl.feature_search", description="Feature ablation study")
