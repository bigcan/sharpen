"""Auto-generated VERBATIM from Kakushadze (2015) arXiv:1601.00991 Appendix A.
Regenerate from the paper; evaluated by _alpha_dsl. cap-using alphas omitted
(no market-cap feed); IndClass->GICS sector; fractional windows round to int."""
