...
from sharpen.envs.allocator_factory import drive_with_conviction, linear_core_trajectory
from sharpen.paper.fill_engine import FillEngine, SimFillEngine
...
class ParityHarness:
    ...
    def run_independent_recompute(
        ...
        **independently**: it walks the harness's own true-month-end calendar
        ...
        via :func:`~sharpen.envs.allocator_factory.drive_with_conviction`. The env
