...
from sharpen.hpo.evaluate import buy_and_hold_total_return, evaluate_for_hpo
from sharpen.logging import trial_namespaced
...
def make_objective(base_config, steps_per_trial, agent_type, device, trial_records):
    ...
    if _env_type == "funding_arb":
        from sharpen.hpo.funding_arb_objective import make_funding_arb_objective
