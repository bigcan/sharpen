...
Usage:
    python -m sharpen.crypto.data.crypto_collector --run-once     # Single fetch
    python -m sharpen.crypto.data.crypto_collector --daemon        # Continuous
"""
...
from sharpen.crypto.data.crypto_loader import (
    DEFAULT_UNIVERSE,
    CryptoLoader,
)
