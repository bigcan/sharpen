...
def run_auth_flow(client_id: str, client_secret: str) -> None:
    ...
    print(f"  2. Log in with your cTrader account (IC Markets demo or FTMO).")
    print(f"  3. Click 'Allow' to authorize the application.")
    print(f"  4. The browser will redirect back here automatically.\n")
    ...
    print(f"    python scripts/ctrader_oauth.py --refresh")
    print("=" * 60 + "\n")
