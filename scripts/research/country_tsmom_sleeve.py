...
log = logging.getLogger("country_tsmom")
...
def main() -> int:
    ...
    log.info("country panel: %d tickers, %d days (%s..%s), %d rebalances",
    ...
    out = {"sleeve": "country_etf_tsmom", "n_tickers": len(keep),
    ...
    (OUT / "country_tsmom_sleeve.json").write_text(json.dumps(out, indent=2))

    print("=" * 76)
    print("T1 — country-ETF TIME-SERIES momentum as a diversifying sleeve")
    print("=" * 76)
