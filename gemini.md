...
**System & Setup:** `[SystemName]_[Version]_[Configuration]`
*   e.g., `Synapse_v2.0_Backtest`

**Experiments:** `[YYYYMMDD]_[Category]_[System]_[ShortDescription]_[Optional:ID]`
*   **Category**: `ARCH`, `FEAT`, `DATA`, `HYPR`, `VALI`.
*   e.g., `20251205_VALI_Synapse_Comprehensive_Backtest`
