...
### Phase 1 — Action/Reward Ablations
Owner: Research Lead
Promotion Gate 1.0: PSR gain >= 0.20 vs. Phase 0 with turnover change <= 5% and no new risk alerts.

Goal
- Identify the simplest action/reward change that improves PSR with stable turnover and drawdown.
...
Acceptance Criteria
- PSR gain >= 0.20 vs. Phase 0; turnover delta <= 5%.
...
Checklist
- [ ] Fracdiff grid over d in {0.2, 0.4, 0.6}; wavelets (db4, levels 2–4).
